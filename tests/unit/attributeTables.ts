 ...
 * used by tests/unit/attribute-tables.test.ts and tests/known-bugs/attribute-tables.test.ts to check that both
 * plugins map the same React-style attribute names on elements. The SVG table is src/utils/svgAttributes.ts.
 */
